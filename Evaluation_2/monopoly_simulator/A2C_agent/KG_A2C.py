...
class MonopolyTrainer_GAT:
    ...
    def load_adj(self):
        ...
        #             'is rented-2-house at', 'is rented-3-house at', 'is rented-4-house at', 'is rented-1-hotel',
        #             'color']
        # range_list = [(40, 47), (47, 52), (52, 59), (59, 64), (64, 72), (72, 80), (80, 86), (86, matrix.shape[0] + 1),
        #               (0, 40)]
        # for i in range(6, 7):
