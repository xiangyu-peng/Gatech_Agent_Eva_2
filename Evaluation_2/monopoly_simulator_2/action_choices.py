...
def buy_property(player, asset, current_gameboard):
    ...
    if asset.owned_by != current_gameboard['bank']:
        ...
        current_gameboard['history']['param'].append(params)
        current_gameboard['history']['return'].append(None)
        print(asset.name, ' is not owned by Bank! Resetting option_to_buy for player and returning code failure code')
        return flag_config_dict['failure_code']
    ...
    if player.current_cash < asset.price:
        ...
        current_gameboard['history']['param'].append(params)
        current_gameboard['history']['return'].append(None)
        print(asset.name, ' is going up for auction since ', player.player_name, ' does not have enough cash to purchase this property. Conducting auction and returning failure code')
