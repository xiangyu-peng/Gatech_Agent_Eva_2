...
upper_path_2level = upper_path.replace('/Evaluation/monopoly_simulator','')
sys.path.append(upper_path)
sys.path.append(upper_path+'/Evaluation')
sys.path.append(upper_path_2level)
sys.path.append(upper_path + '/Evaluation/monopoly_simulator')
...
def play_tournament_with_novelty_1(tournament_log_folder=None, meta_seed=5, num_games=100, novelty_index=23):
    ...
    print(winner_num/len(new_winners))
...
# play_tournament_without_novelty('/tournament_without_novelty_4/', meta_seed=1, num_games=200)

play_tournament_with_novelty_1('/tournament_with_novelty/', meta_seed=1, num_games=200, novelty_index=50)
