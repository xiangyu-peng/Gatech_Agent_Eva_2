...
import numpy
import diagnostics
from monopoly_simulator_background.card_utility_actions import move_player_after_die_roll
from monopoly_simulator_background.agent import Agent

from monopoly_simulator_background import initialize_game_elements
from monopoly_simulator_background.action_choices import roll_die
import numpy as np
from monopoly_simulator_background.card_utility_actions import move_player_after_die_roll
# import background_agent_v1
# import background_agent_v1_deprecated
# import background_agent_v2
from monopoly_simulator_background import background_agent_v3
# import background_agent_v4
from monopoly_simulator_background import read_write_current_state
from monopoly_simulator_background import simple_decision_agent_1
import json
...
def test_gameboard(game_schema_file): # we use this function for testing various things. Make sure to leave it commented, since otherwise, circular import dependencies will be introduced.
    ...
    player_decision_agents2['player_1'] = Agent(**simple_decision_agent_1.decision_agent_methods)
    player_decision_agents2['player_2'] = Agent(**simple_decision_agent_1.decision_agent_methods)
    player_decision_agents2['player_3'] = Agent(**simple_decision_agent_1.decision_agent_methods)
    player_decision_agents2['player_4'] = Agent(**background_agent_v3.decision_agent_methods)
