from monopoly_simulator_background import action_choices
from monopoly_simulator_background import agent_helper_functions  # helper functions are internal to the agent and will not be recorded in the function log.
            ...
            if agent_helper_functions.will_property_complete_set(player, current_location, current_gameboard):
                ...
                if to_mortgage:
                    ...
                    if to_sell:
                        ...
                        logger.debug(player.player_name + ': I am attempting to sell property ' + params[
...
def handle_negative_cash_balance(player, current_gameboard):
    ...
    for a in sorted_player_assets_list:
        ...
        if player.current_cash >= 0:
            return 1  # we're done
    # print(player.current_cash,player.player_name)
