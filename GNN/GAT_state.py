...
class MonopolyTrainer:
    def __init__(self, params,
        ...
        # kg matrix
        self.adj = None
        self.adj_path = self.params['adj_path'] + '_' + str(exp_dict['novelty_num'][0]) + '_' + str(exp_dict['novelty_num'][1])+ '_kg.npy'
        ...
        if self.logger_use:
            hyper_config_str = '_n' + str(self.n_train_processes) + '_lr' + str(self.learning_rate) + '_ui' + str(
                self.update_interval) \
                               ...
                               str(exp_dict['novelty_num'][0]) + '_' + str(exp_dict['novelty_num'][1]) + '_gat_ran_' + gat_use
