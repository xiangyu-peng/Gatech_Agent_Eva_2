...
# python GAT_part.py --novelty_change_num 0,18,6 --novelty_change_begin 0,1,3 --novelty_introduce_begin 0,150,300 --retrain_type baseline --exp_name 18_1 --kg_use False --seed 10
...
class MonopolyTrainer_GAT:
    def __init__(self,
        ...
        if pretrain_model:
            ...
            if 'gat' in self.retrain_type:
                ...
                self.config_model.entity_id_file_path = self.params['entity_id_file_path'] + '/entity_id_no.json'
    ...
    def load_adj(self):
        ...
        if os.path.exists(self.adj_path):
            ...
            # print('Successful load game rule!', self.adj_path)
        else:
    ...
    def train(self):
        ...
        while step_idx < self.max_train_steps and self.spend_time < 300:
            ...
            while j < self.update_interval:
                ...
                if retrain_useful_sig and self.interface.check_relative_state(s_check[0], self.novelty_spaces):
                    j += 1
                    retrain_signal = True
...
if __name__ == '__main__':
    ...
    if 'gat' in args.retrain_type:
        pre_trained_model = '/media/becky/GNOME-p3/monopoly_simulator_background/weights19_1_gat_part_seed_896000.pkl'
    else:
        pre_trained_model = '/media/becky/GNOME-p3/monopoly_simulator_background/weights19_1_baseline_seed_9147000.pkl'
    ...
    for params in param_list:  # run different hyper parameters in sequence
        trainer = MonopolyTrainer_GAT(params,
                                  ...
                                  test_required=True,
                                  tf_use=True,
                                  pretrain_model=pre_trained_model,
